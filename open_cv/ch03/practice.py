...
# # cv2.FONT_HERSHEY_SIMPLEX : 보통 크기의 산 세라프 (sans-serif) 글꼴
...
# #           그릴위치 , 텍스트 내용 ,    시작위치 ,         폰트 종류  ,       크기  ,   색깔 ,   두깨
# cv2.putText(img, 'Nado Plain', (20, 150),cv2.FONT_HERSHEY_PLAIN, SCALE, COLOR, THICKNESS)
# cv2.putText(img, 'Nado Script', (20, 250),cv2.FONT_HERSHEY_SCRIPT_SIMPLEX, SCALE, COLOR, THICKNESS)
